...
// Use forwardRef to fix the ref warning with shadcn/ui buttons
const PlatformConnectButton = React.forwardRef<
  HTMLButtonElement, 
...
PlatformConnectButton.displayName = 'PlatformConnectButton';

// Export the component
export { PlatformConnectButton };